...
|------|-----|---|
| Home | عبدالرحمن الإدريسي - مهندس برمجيات متخصص | مهندس برمجيات بخبرة في الرياض. متخصص في React و Next.js و Python و DevOps. عرض أعمالي وتوظيفي اليوم. |
...
| Contact | تواصل مع عبدالرحمن الإدريسي - مهندس برمجيات | تواصل مع عبدالرحمن الإدريسي لمشاريع التطوير المتكامل أو الاستشارات. بناءً في الرياض، متاح عالميًا. |
